...
export const dustCollectionSystemWoodworkingDustCollector: Product = {
  ...
  model: "-",
  brand: "FORST FILTER",
  description: "Woodworking dust collection system with inclined cartridge design. Features 99.9% efficiency, pulse jet cleaning, modular construction, and customizable specifications for workshops.",
