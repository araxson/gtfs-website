...
export const inclinedCartridgeDustCollector: Product = {
  ...
  model: "SFF/IC-1000",
  brand: "FORST FILTER",
  description: "Inclined cartridge dust collector with innovative angled design for optimized filtration. Features 99.9% efficiency, pulse-jet cleaning, and heavy-duty steel construction.",
