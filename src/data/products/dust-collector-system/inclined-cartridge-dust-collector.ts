...
export const inclinedCartridgeDustCollector: Product = {
  ...
  model: "SFF/IC-1000",
  brand: "GTFS",
  description: "Inclined cartridge dust collector with innovative angled design for optimized filtration. Features high-efficiency efficiency, pulse-jet cleaning, and heavy-duty steel construction.",
