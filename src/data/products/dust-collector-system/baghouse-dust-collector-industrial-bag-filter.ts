...
export const baghouseDustCollectorIndustrialBagFilter: Product = {
  ...
  model: "-",
  brand: "GTFS",
  description: "Baghouse dust collector with industrial bag filter system. Features inclined cartridge design, automatic pulse-jet cleaning, and customizable specifications for various industries.",
