...
export const industrialBagDustCollector: Product = {
  id: "industrial-bag-dust-collector",
  name: "Industrial Bag Dust Collector",
  productType: "Industrial Bag Dust Collector",
  model: "-",
  brand: "GTFS",
  description: "Industrial bag dust collector with inclined cartridge design for heavy-duty applications. Features high-efficiency efficiency, pulse-jet cleaning, and durable steel construction.",
  detailedDescription: `The Industrial Bag Dust Collector features an innovative inclined cartridge design that optimizes dust filtration efficiency and facilitates easier cleaning and maintenance. This dust collector is widely used in industries such as metallurgy, cement, pharmaceuticals, and woodworking, providing effective removal of fine and coarse dust particles. Its compact structure and advanced pulse-jet cleaning system ensure long service life and stable operation even under harsh industrial conditions.
...
Why Choose Our Industrial Bag Dust Collector:
