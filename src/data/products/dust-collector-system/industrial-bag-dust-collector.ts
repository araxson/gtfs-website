...
export const industrialBagDustCollector: Product = {
  ...
  model: "-",
  brand: "FORST FILTER",
  description: "Industrial bag dust collector with inclined cartridge design for heavy-duty applications. Features 99.9% efficiency, pulse-jet cleaning, and durable steel construction.",
