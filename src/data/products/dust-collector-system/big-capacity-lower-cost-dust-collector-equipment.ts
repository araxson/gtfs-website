...
export const bigCapacityLowerCostDustCollectorEquipment: Product = {
  ...
  model: "-",
  brand: "GTFS",
  description: "Large capacity, cost-effective dust collector with inclined cartridge design. Features pulse-jet cleaning, high-efficiency efficiency, and modular construction for industrial applications.",
