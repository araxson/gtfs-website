...
Test Results:
Classification: 0.3um HOT.DOP Test - Scan Tested: Passed, high-efficiency over
Standard: high-efficiency over
...
610×1219×50/65: Air flow 860/1200 m³/h`,
  ...
  features: [
    ...
    "HOT.DOP test passed with high-efficiency efficiency"
  ],
  specialFeatures: ["-"],
  advantages: ["-"],
  benefits: ["-"],
  ...
  technicalSpecs: {
    filtrationEfficiency: "high-efficiency @ 0.3μm (HEPA), high-efficiency (ULPA)",
