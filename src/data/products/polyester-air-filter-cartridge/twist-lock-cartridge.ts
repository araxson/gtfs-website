...
export const twistLockCartridge: Product = {
  ...
  model: "-",
  brand: "FORST FILTER",
  description: "Twist-lock filters with 47 or 52 mm high locking mechanisms in cylindrical or conical designs. Compatible with 25 different filtration media types for various industries including gas turbine intake applications.",
  detailedDescription: "FORST Air Filtration's twist-lock filters are equipped with 47 or 52 mm high locking mechanisms in cylindrical or conical designs. We also offer American twist lock filters, mainly for gas turbine intake housings. The Twist lock filter cartridge can be equipped with any of Nordic Air Filtration's 25 different high-quality filtration media, making it suitable for a wide range of industries and dust types, including abrasive, toxic and explosive dust. It is suitable for air filtration of dust and fumes from cement, metal/aluminum, food and beverage, wood products, chemicals, powder coatings, plasma/laser cutting, sandblasting, textiles, welding and casting. Material options include galvanized steel top cap, EPDM gasket, galvanized steel inner mesh, optional glued or ultrasonic welded straps, galvanized steel filter media, and compatibility with Nordic Air Filtration's comprehensive filter media selection for optimal performance across diverse industrial applications.",
