...
export const panelAirFiltersCategory: ProductCategory = {
  ...
  overview: "Panel / Pre-Filters — Rugged pre-filtration for HVAC and process systems. Flat panel filters for general air cleaning with various efficiency levels.",
