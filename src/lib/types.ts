...
export interface Dimensions {
  ...
  // Filter media specific dimensions
  rollWidth?: string;
  rollLength?: string;
  sheetSize?: string;
  thickness?: string;
  ...
  // Filter cartridge specific dimensions
  flangeSize?: string;
  shape?: string;
...
export interface Materials {
  filterMedia?: string;
  endCap?: string | string[];
  gasket?: string | string[];
  core?: string;
  construction?: string | string[];
  // Filter media specific materials
  composition?: string;
  backing?: string;
  additives?: string;
  treatment?: string;
...
export interface ConnectionTypes {
  type: 'twist-lock' | 'lug' | 'square-cap' | 'threaded' | 'flange' | 'custom';
  lugCount?: number;
  mechanism?: string;
  size?: string;
}
...
export type CertificationType = 'ISO' | 'ATEX' | 'CE' | 'OEM' | 'Custom';
