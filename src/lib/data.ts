...
export async function getFeaturedProducts(limit: number = 6): Promise<Product[]> {
  ...
  // For now, return the first N products. In a real app, you might have a featured flag
