...
export default function ContactPage() {
        ...
        <div className="max-w-2xl mx-auto text-center py-16">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              <p>Need immediate assistance? Call us at <strong>+1 (234) 567-8900</strong></p>
            </div>
          </div>
        </div>
      </PageContainer>
  ...
  return (
    ...
    <PageContainer>
      <PageHeader
        title="Contact Us"
        description="Get in touch with our technical experts for product information, quotes, and support."
        breadcrumbs={[
          { title: "Contact" }
        ]}
      />
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select onValueChange={(value) => handleInputChange("productInterest", value)}>
                    ...
                    <SelectContent>
                      <SelectItem value="polyester-filters">Polyester Air Filter Cartridges</SelectItem>
                      <SelectItem value="cellulose-filters">Cellulose Air Filter Cartridges</SelectItem>
                      <SelectItem value="gas-turbine-filters">Gas Turbine Air Intake Filters</SelectItem>
                      <SelectItem value="pleated-bag-filters">Pleated Bag Filters</SelectItem>
                      <SelectItem value="panel-filters">Panel Air Filters</SelectItem>
                      <SelectItem value="filter-media">Filter Media</SelectItem>
                      <SelectItem value="dust-collectors">Dust Collection Systems</SelectItem>
          ...
          <Card className="border-destructive/20 bg-destructive/5 hover:shadow-xs transition-shadow duration-200">
            <CardHeader className="space-y-4">
              ...
              <CardDescription className="text-destructive/80 text-base">
                For urgent technical issues or equipment failures
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4 p-4 rounded-lg bg-destructive/10">
                ...
                <div className="text-sm text-destructive/80">
                  Available for existing customers with critical system failures
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <div className="space-y-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            We serve customers across North America with global shipping available for international clients.
          </p>
        </div>
          ...
          <Card className="hover:shadow-xs transition-shadow duration-200">
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 rounded-full bg-primary"></div>
                  <span className="text-sm font-medium">ATEX Compliance</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 rounded-full bg-primary"></div>
