...
export const metadata: Metadata = {
  title: "Global Tech Fluid Services - Industrial Filters & Pumps",
  description: "Leading provider of industrial filters and pumps. Delivering efficient & durable filtration and pumping solutions with advanced production technology.",
  keywords: "industrial filters, industrial pumps, dust collector cartridges, air filtration, polyester filters, cellulose filters, gas turbine filters, pump systems, pumping solutions",
  ...
  openGraph: {
    ...
    title: "Global Tech Fluid Services - Industrial Filters & Pumps",
    description: "Leading provider of industrial filters and pumps. Delivering efficient & durable filtration and pumping solutions.",
